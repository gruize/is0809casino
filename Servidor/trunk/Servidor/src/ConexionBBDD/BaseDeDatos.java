...
public class BaseDeDatos {
	...
	public BaseDeDatos() throws SQLException{
		...
		//Subir el properties y sino se sube eliminar todo el codigo de cargar el archivo.
	...
	*/
	...
	/* METODO EMPEZADO PARA COMPROBAR REGISTRO DEL JUGADOR*/
	public boolean comprobarJugador(String usuario,String password) {
		
		//baseDatos.ejecutarSelect("CLIENTES","USUARIO,PASSWORD","USUARIO = "+usuario+" AND PASSWORD = "+password);
		//if (baseDatos == null) return false;
		return true;
	}
