...
public class HibernateUtil {
     ...
     * Examples: <br>
     * <code>CONFIG_FILE_LOCATION = "/DAO/hibernate.conf.xml".
     * CONFIG_FILE_LOCATION = "/com/foo/bar/myhiberstuff.conf.xml".</code>
     */

    private static String CONFIG_FILE_LOCATION = "/DAO/hibernate.cfg.xml";
                ...
                if (sessionFactory == null) {
                    try {
                        ...
                        System.out.println("Hibernate Util: cargado el fichero hibernate.cfg.xml");
                         ...
                         System.err.println("Error Error Creating SessionFactory: "+e.getMessage());
